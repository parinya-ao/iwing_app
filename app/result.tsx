...
const saveToCSV = async (
  ...
  // Convert to Thailand local time (Asia/Bangkok timezone)
  const options = {
    ...
    minute: "2-digit", // "00"
    second: "2-digit", // "00"
    hour12: true, // Optional: to use 12-hour format (AM/PM)
  };
  ...
  try {
    ...
    // Prepare CSV content
    const csvHeader = `Training Result :${formattedDate}\n`;
    const csvRows = data
    ...
    Alert.alert(
      "Error",
      `An error occurred while saving the CSV file: ${error.message}`
    );
  }
};
const FullResult = ({
